...
namespace Bluetooth
{
	...
	public class BtDevice
	{
		...
		[DllImport("BTAccess.dll")]
		static extern eBTRC			  BT_PANConnect(string DeviceAddr, ePAN_NODETYPE ePanType);
		[DllImport("BTAccess.dll")]
		static extern eBTRC			  BT_PANDisconnect(string DeviceAddr, ePAN_NODETYPE ePanType);
